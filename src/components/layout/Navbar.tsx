      ...
      <div className="mx-auto flex h-16 max-w-300 items-center justify-between px-8">
        <Link href="/" className="group flex items-center gap-2.5">
          <span className="relative grid place-items-center">
            <span className="absolute -inset-2 rounded-xl opacity-0 blur-md transition-opacity duration-300 group-hover:opacity-100 bg-[radial-gradient(circle_at_30%_20%,rgba(0,180,255,0.35),transparent_55%),radial-gradient(circle_at_70%_80%,rgba(170,60,255,0.28),transparent_55%)]" />
            <Image
          ...
          {links.map((l) => (
            <a
              ...
              className="
                ...
                after:bg-[linear-gradient(90deg,rgba(0,180,255,0.9),rgba(170,60,255,0.9))]
